...
class TB_Image_Module extends Themify_Builder_Component_Module {
	...
	return array(
		...
		'options' => array(
		    ...
		    array('name' => 'circle', 'value' => __('Circle', 'themify'), 'help' => __('Circle appearance is effective on square format image only.', 'themify'))
		)
	    ),
	    array(
		'id' => 'image_size_image',
	...
	$image_tab = array(
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			   self::get_margin(' .image-wrap img', 'i_t_m')
			)
		    ),
		    'h' => array(
			'options' => array(
