...
class TB_Buttons_Module extends Themify_Builder_Component_Module
{
		...
		$button_link = array(
			...
			self::get_expand( 'bg', array(
				self::get_tab( array(
					'n' => array(
						'options' => array(
							self::get_color( ' .module-buttons-item a', 'button_background_color', 'bg_c', 'background-color' )
						)
					),
					'h' => array(
						'options' => array(
							self::get_color( ' .module-buttons-item a', 'button_background_color', 'bg_c', 'background-color', 'hover' )
						)
					)
				) )
			) ),
	...
	protected function _visual_template()
	{
        ...
        alignment = (!data.alignment || 'undefined' == data.alignment )? '' : data.alignment + '-align',
