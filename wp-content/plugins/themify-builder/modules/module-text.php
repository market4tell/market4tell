...
class TB_Text_Module extends Themify_Builder_Component_Module {
	...
	$dropcap = array(
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_color('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_background_color', 'bg_c', 'background-color')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_color('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_b_c', 'bg_c', 'background-color')
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_font_family('.tb_text_dropcap .tb_text_wrap::first-letter', 'font_dropcap_family'),
			    self::get_color('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_font_color'),
			    self::get_font_size('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_font_size'),
			    self::get_line_height('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_line_height'),
			    self::get_text_transform('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_letter_transform'),
			    self::get_font_style('.tb_text_dropcap .tb_text_wrap::first-letter', 'font_dropcap', 'font_dropcap_bold'),
			    self::get_text_decoration('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_decoration_regular'),
			    self::get_text_shadow('.tb_text_dropcap .tb_text_wrap::first-letter', 't_sh_dr')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_font_family('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'f_d_f_h'),
			    self::get_color('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_f_c_h'),
			    self::get_font_size('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_f_s_h'),
			    self::get_line_height('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_l_t_h'),
			    self::get_text_transform('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_l_tr_h'),
			    self::get_font_style('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'f_d_h', 'f_d_b_h'),
			    self::get_text_decoration('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_d_r_h'),
			    self::get_text_shadow('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 't_sh_dr_h')
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_padding('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_padding')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_padding('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_p_h')
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_margin('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_margin')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_margin('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_m_h')
			)
		    )
		))
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_border('.tb_text_dropcap .tb_text_wrap::first-letter', 'dropcap_border')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_border('.tb_text_dropcap .tb_text_wrap:hover::first-letter', 'd_b_h')
			)
		    )
		))
	    ))
