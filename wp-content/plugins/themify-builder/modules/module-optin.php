...
class TB_Optin_Module extends Themify_Builder_Component_Module {
	...
	function __construct() {
		...
		include( THEMIFY_BUILDER_INCLUDES_DIR. '/optin-services/base.php' );
	...
	function ajax_tb_optin_get_settings() {
		...
		foreach ( $providers as $id => $instance ) {
			...
			$providers_binding[ $id ] = array(
				'hide' => array_diff( array_keys( $providers ), array( $id ) ),
				'show' => array( $id ),
			);
		}
			...
			<form class="tb_optin_form" name="tb_optin" method="post">
				<# if ( ! data.fname_hide ) { #>
					<div class="tb_optin_fname">
						...
						<input type="text" name="tb_optin_fname" required="required" />
					</div>
				<# } #>
				<# if ( ! data.lname_hide ) { #>
					<div class="tb_optin_lname">
						<label class="tb_optin_lname_text">{{{ data.label_lastname }}}</label>
						<input type="text" name="tb_optin_lname" required="required" />
					</div>
				<# } #>
				<div class="tb_optin_email">
					<label class="tb_optin_email_text">{{{ data.label_email }}}</label>
					<input type="email" name="tb_optin_email" required="required" />
				</div>
				<div class="tb_optin_submit">
					<button>{{{ data.label_submit }}}</button>
				</div>
			</form>
