...
if (TFCache::start_cache($args['mod_name'], self::$post_id, array('ID' => $args['module_ID']))):
    ...
    $container_class = apply_filters('themify_builder_module_classes', array(
        'module gallery', 'module-' . $args['mod_name'], $args['module_ID'], 'gallery-columns-' . $columns, $masonry_class, 'layout-' . $fields_args['layout_gallery'], $fields_args['appearance_gallery'], $fields_args['css_gallery'], $animation_effect
    ...
    <div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args)); ?>>
        ...
        if (!empty($fields_args['gallery_images'])) {
            // render the template
            self::retrieve_template('template-' . $args['mod_name'] . '-' . $fields_args['layout_gallery'] . '.php', array(
