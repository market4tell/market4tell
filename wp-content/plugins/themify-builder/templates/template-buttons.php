...
if (TFCache::start_cache($args['mod_name'], self::$post_id, array('ID' => $args['module_ID']))):
    ...
    $container_class = apply_filters('themify_builder_module_classes', array(
			'module', 'module-' . $args['mod_name'], $args['module_ID'], $fields_args['css_button'], $animation_effect, $fields_args['buttons_size'], $fields_args['buttons_style'], $fields_args['buttons_shape']
    ), $args['mod_name'], $args['module_ID'], $fields_args);
	if(!empty($fields_args['$fields_args'])){
	    $fields_args['alignment'] = $fields_args['display']='';
	}
	elseif(!empty($fields_args['alignment']) ){
