...
if (TFCache::start_cache($args['mod_name'], self::$post_id, array('ID' => $args['module_ID']))):
    ...
    $container_class = array('module', 'module-' . $args['mod_name'], $args['module_ID'],$fields_args['appearance_image_service_menu'], $fields_args['style_service_menu'], $fields_args['css_service_menu'], $animation_effect);
    if ($highlight === true) {
        ...
        <div class="tb-image-content">
		    ...
		    <?php if ($fields_args['price_service_menu'] !== '' || isset($fields_args['add_price_check']) ): ?>
                <div class="tb-menu-price">
				    <?php if( $fields_args['price_service_menu'] !== '' && $fields_args['add_price_check'] == 'no') {
