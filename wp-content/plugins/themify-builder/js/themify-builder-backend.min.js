...
b.Instances.Builder[b.builderIndex].$el.triggerHandler("tb_init");sessionStorage.getItem("focusBackendEditor")&&(b._backendBuilderFocus(),sessionStorage.removeItem("focusBackendEditor"));ThemifyStyles.init(b.Constructor.data,b.Constructor.breakpointsReverse);themifyBuilder.is_gutenberg_editor||d()}};b._backendSwitchFrontend=function(c){a("#builder_switch_frontend_noncename").val("ok");f=!0;"publish"===a("#original_post_status").val()?themifyBuilder.is_gutenberg_editor?(a(".editor-post-publish-button").length?
a(".editor-post-publish-button").trigger("click"):a(".editor-post-publish-panel__toggle").trigger("click"),b.redirectFrontend=c,a("#tb_switch_frontend").trigger("click.frontend-btn")):a("#publish").trigger("click"):themifyBuilder.is_gutenberg_editor?(a(".editor-post-save-draft").trigger("click"),b.redirectFrontend=c):a("#save-post").trigger("click")};b._backendBuilderFocus=function(){a("#page-buildert").trigger("click");themifyBuilder.is_gutenberg_editor?b.Utils.scrollToDropped(b.toolbar.el):b.Utils.scrollTo(b.toolbar.$el.offset().top-
a("#wpadminbar").height())};a(function(){if(c[0].classList.contains("post-php")){var b=document.getElementById("post-lock-dialog");null===b||b.classList.contains("hidden")||Themify.LoadAsync(themifyBuilder.builder_url+"/js/themify-ticks.js",function(){c[0].classList.contains("tb_restriction")?TB_Ticks.init(themifyBuilder.ticks,window).show():TB_Ticks.init(themifyBuilder.ticks,window).ticks()},null,null,function(){return"undefined"!==typeof TB_Ticks})}if("function"===typeof window.icl_copy_from_original){var d=
window.icl_copy_from_original;window.icl_copy_from_original=function(b,c){d(b,c);a.ajax({url:ajaxurl,type:"POST",data:{action:"themify_builder_icl_copy_from_original",source_page_id:c,source_page_lang:b},success:function(b){"-1"!=b&&a("#page-builder .themify_builder.themify_builder_admin").empty().append(b).contents().unwrap()}})}}});a(window).load(function(){b.Constructor.getForms(b.render)})})(jQuery,tb_app);
