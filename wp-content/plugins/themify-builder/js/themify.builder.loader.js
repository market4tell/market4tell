...
(function ($, window, document,Themify) {
    'use strict';
    $(document).ready(function () {
        ...
        if (wp === undefined || wp.customize === undefined) {
            ...
            for(var i=builder.length-1;i>-1;--i){
                if(!builder[i].classList.contains('not_editable_builder')){
                    var a = document.createElement('a'),
                        span = document.createElement('span');
                        a.href = 'javascript:void(0);';
                        a.className = 'tb_turn_on js-turn-on-builder';
                        span.className = 'dashicons dashicons-edit';
                        span.dataset['id'] = builder[i].dataset.postid;
                        a.appendChild(span);
                        a.appendChild(document.createTextNode(tbLoaderVars.turnOnBuilder));
        ...
        function init(){
            Themify.body.one('click.tbloader', '.toggle_tb_builder a:first, a.js-turn-on-builder', function (e) {
                ...
                var post_id = this.childNodes[0].dataset['id'];
...
})(jQuery, window, document,Themify);