...
0<b.length&&a.ajax({url:Themify_Icons.ajaxurl,data:{action:"tf_get_icon",tf_icon:c},success:function(a){b.removeClass().addClass(a)}});Themify_Icons.closeLightbox()},closeLightbox:function(){a("#themify_lightbox_fa",Themify_Icons.top).animate({top:Themify_Icons.top.height()},400,function(){a("#themify_lightbox_overlay",Themify_Icons.top).hide();a(this).hide()})},Category:function(){Themify_Icons.top.on("click",".themify-lightbox-icon li",function(c){c.preventDefault();c.stopPropagation();c=a(this).hasClass("selected");
a(this).closest(".themify-lightbox-icon").find(".selected").removeClass("selected");if(c)a(this).closest(".lightbox_container").find("section").fadeIn("fast",function(){a("#themify-search-icon-input",Themify_Icons.top).trigger("keyup")});else{c=a(this).data("id");var b=a("#"+c,Themify_Icons.top);a(this).addClass("selected");0<b.length&&a(this).closest(".lightbox_container").find("section").not("#"+c).fadeOut("fast",function(){b.fadeIn("normal")})}})},Search:function(){a.expr[":"].contains=a.expr.createPseudo(function(c){return function(b){return 0<=
